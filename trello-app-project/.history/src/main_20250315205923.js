...
function buildModalForm() {
	return `
				<div class="position-fixed top-0 start-0 w-100 bg-dark bg-opacity-50">
					<form class="p-4 border rounded bg-light text-start fw-semibold w-50 position-relative">
						...
						<button type="submit" class="btn btn-primary bg-primary bg-gradient border-secondary">Add card
							TODO</button>
