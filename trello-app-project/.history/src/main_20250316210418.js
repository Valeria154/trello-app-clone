...
function buildModalForm() {
	return `
									<div class="position-fixed top-50 start-50 translate-middle w-100 bg-dark bg-opacity-50 hidden">
						<div class="p-4 border rounded bg-light text-start fw-semibold w-50 position-relative">
							<div class="mb-3">
