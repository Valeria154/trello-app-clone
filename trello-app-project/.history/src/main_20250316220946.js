...
function buildTodoTemplate({ id, title, description, user, status, createdAt }) {
	...
	return `
							...
							<div class="card-body">
								<h4 class="card-title text-start">titl</h4>
								<p class="card-text text-start">dgdgdfghd</p>
							</div>
							<div class="card-footer d-flex justify-content-between">
								<div class="card-title text-start">titl</div>
								<div class="card-text text-start">dgdgdfghd</div>
							</div>
						</div>
